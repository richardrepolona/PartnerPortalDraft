...
WebUI.setText(findTestObject('Registration and Login Page/WebBlock_Login/Login_Username_Input'), Username)

WebUI.setText(findTestObject('Registration and Login Page/WebBlock_Login/Login_Password_Input'), Password)
